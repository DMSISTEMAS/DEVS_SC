...
public class Bitacora  implements java.io.Serializable {
     ...
     private Long aseo;
     private Long catequesisFamiliar;
     private Date misaSalida;

    public Bitacora() {
    }

    public Bitacora(Registro registro, Integer semana, Date fecha, Long puntualidad, Long asistencia, Long conducta, Date misa, Long tarea, Long extra, String observaciones, String ruta, String justificante, Boolean estatus, Long aseo, Long catequesisFamiliar, Date misaSalida) {
    ...
    public Long getCatequesisFamiliar() {
        return this.catequesisFamiliar;
    }
    
    public void setCatequesisFamiliar(Long catequesisFamiliar) {
        this.catequesisFamiliar = catequesisFamiliar;
    }
