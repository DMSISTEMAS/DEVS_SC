...
public class CatequistaBean implements Serializable {
	...
	public void actualizar() {
		...
		// COLOCAMOS EL ID DEL LA DIRECCIÓN
		DireccionDao dDao = new DireccionDaoImp();
		this.d = dDao.listarIdDireccion(this.catequista.getDireccion().getCalle());
		this.catequista.setDireccion(d);

		// COLOCAMOS EL ID DEL MUNICIPIO
		MunicipioDao mDao = new MunicipioDaoImp();
		this.m = mDao.listarIdMunicipio(this.catequista.getMunicipio().getNombre());
		this.catequista.setMunicipio(m);
		cDao.actualizar(catequista);
		this.catequista = new Catequista();
		this.address = "";
		this.codigo = "";
		this.municipio = "";
