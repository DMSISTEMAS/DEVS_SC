...
public class Lista extends Conexion {

    @SuppressWarnings({"unchecked"})
    public void getLista(String ruta, String IDHORARIO, String IDLIBRO, String IDCATEQUISTA) {
        this.Conectar();
        ...
        parameters.put("IDCATEQUISTA", IDCATEQUISTA);
